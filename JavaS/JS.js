...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"small", num:300, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.4, areaHeight:.5, color:"#FFFFFF", fill:false}, 
								{id:"medium", num:100, fromX:0, toX:this.totalWidth,  ballwidth:8, alphamax:0.3, areaHeight:1, color:"#FFFFFF", fill:true}, 
								{id:"large", num:10, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.2, areaHeight:1, color:"#FFFFFF", fill:true}];
		this.particleArray = [];
		this.lights = [{ellipseWidth:50, ellipseHeight:50, alpha:0, offsetX:0, offsetY:0, color:"##FFFFFF"}, 
						{ellipseWidth:350, ellipseHeight:250, alpha:0.5, offsetX:-50, offsetY:0, color:"#FFFFFF"}, 
						{ellipseWidth:100, ellipseHeight:80, alpha:0.5, offsetX:80, offsetY:-50, color:"#FFFFFF"}];
